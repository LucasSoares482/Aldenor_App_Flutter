// lib/services/currency_service.dart (Atualizado com API Real)
import 'dart:convert';
...
class CurrencyService {
  ...
  Future<List<Currency>> getCurrencies() async {
    try {
      ...
      final url = '$baseUrl/json/last/$currencyString';
  ...
  Future<Currency?> getSpecificCurrency(String currencyCode) async {
    try {
      final url = '$baseUrl/json/last/$currencyCode-BRL';
  ...
  Future<List<Currency>> getCurrencyHistory(String currencyCode, int days) async {
    try {
      final url = '$baseUrl/json/daily/$currencyCode-BRL/$days';
  ...
  Future<bool> isApiWorking() async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/json/last/USD-BRL'),
